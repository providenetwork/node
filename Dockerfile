...
# libra installation
# RUN /bin/bash -c 'git clone https://github.com/libra/libra.git && pushd libra && ./scripts/dev_setup.sh && cp ./scripts/cli/start_cli_testnet.sh /usr/local/bin/libra.sh && popd'
